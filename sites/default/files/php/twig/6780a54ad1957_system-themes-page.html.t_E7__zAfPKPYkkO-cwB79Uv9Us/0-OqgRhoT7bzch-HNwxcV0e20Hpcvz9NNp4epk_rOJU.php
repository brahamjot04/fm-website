...
class __TwigTemplate_ed0ddec90b98e7dbf7f9f0296da5896e extends Template
{
...
($context["card_alignment"] ?? null), 64, $this->source)), "card-list__item"];
            ...
            ";
              ...
              <div class=\"card__content\">
                <h3";
                // line 87
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $this->extensions['Drupal\Core\Template\TwigExtension']->createAttribute(["id" => $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["theme"], "title_id", [], "any", false, false, true, 87), 87, $this->source)]), "addClass", [($context["theme_title_classes"] ?? null)], "method", false, false, true, 87), 87, $this->source), "html", null, true);
                yield " id=";
...
";
    ...
    {
        return new Source("", "themes/gin/templates/system/system-themes-page.html.twig", "/var/www/html/fmcrs/themes/gin/templates/system/system-themes-page.html.twig");
    }
