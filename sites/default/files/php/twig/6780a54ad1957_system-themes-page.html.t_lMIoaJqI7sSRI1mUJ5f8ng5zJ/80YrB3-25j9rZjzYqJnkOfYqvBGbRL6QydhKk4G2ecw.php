...
class __TwigTemplate_38dcdfbc4c61197ee3bbc740a8b554c4 extends Template
{
...
($context["card_alignment"] ?? null), 63, $this->source)), "card-list__item"];
            ...
            ";
              ...
              <div class=\"card__content\">
                <h3";
                // line 86
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $this->extensions['Drupal\Core\Template\TwigExtension']->createAttribute(["id" => $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, $context["theme"], "title_id", [], "any", false, false, true, 86), 86, $this->source)]), "addClass", [($context["theme_title_classes"] ?? null)], "method", false, false, true, 86), 86, $this->source), "html", null, true);
                yield " id=";
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/system-themes-page.html.twig", "/var/www/html/fmcrs/core/themes/claro/templates/system-themes-page.html.twig");
    }
